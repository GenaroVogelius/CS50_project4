...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'network/react-front/dist')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'network/react-front/dist/assets'),
]
 # !agregaste esto


CORS_ALLOW_ALL_ORIGINS = True # !agregaste esto
# sino podes poner CORS_ORIGIN_WHITELIST = ["http://localhost:3000"] si estuvieras en produccion la ip seria la del host
